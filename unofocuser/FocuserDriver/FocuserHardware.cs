...
//
// ASCOM Focuser hardware class for ssagerianunofocuser
//
...
namespace ASCOM.ssagerianunofocuser.Focuser
{
    ...
    internal static class FocuserHardware
    {
        ...
        private static UnoFocuserTransport transport = new UnoFocuserTransport();
        internal const string comPortProfileName = "COM Port";
        internal const string comPortDefault = "COM6";
        ...
        static FocuserHardware()
        {
            try
            {
                ...
                tl = new TraceLogger("", "ssagerianunofocuser.Hardware");
            ...
            if (newState) // We are connecting
            {
                ...
                else // Instance not already connected, so connect it
                {
                    ...
                    if (uniqueIds.Count == 0)
                    {
                        ...
                        {
                            LogMessage("SetConnected", $"Hardware connect failed: {ex.Message}");
                            throw;
                        }
                    }
                    else
        ...
        internal static int MaxIncrement
        {
            get
            {
                return transport.GetMaxPosition();
            }
        }
        ...
        {
            transport.MoveAbsolute(Position);
        }
        ...
        internal static double StepSize
        {
            get
            {
                LogMessage("StepSize Get", "Physical step size is not known.");
