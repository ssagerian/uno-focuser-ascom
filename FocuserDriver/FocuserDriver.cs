...
//
// ASCOM Focuser driver for ssagerianunofocuser
//
...
namespace ASCOM.ssagerianunofocuser.Focuser
{
    ...
    //
    // Your driver's DeviceID is ASCOM.ssagerianunofocuser.Focuser
    //
    // The COM Guid attribute sets the CLSID for ASCOM.ssagerianunofocuser.Focuser
    // The COM ClassInterface/None attribute prevents an empty interface called _ssagerianunofocuser from being created and used as the [default] interface
    //
    ...
    public class Focuser : ReferenceCountedObjectBase, IFocuserV4, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ssagerianunofocuser"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Focuser()
        {
            try
            {
                ...
                tl = new TraceLogger("", "ssagerianunofocuser.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.ssagerianunofocuser.Focuser", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
